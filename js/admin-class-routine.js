 ...
 * Version: v2.0 — Database-driven Departments/Courses/Batches
...
(function () {
    ...
    // =========================================================
    // LOAD MASTER DATA (Departments, Courses, Batches)
    // =========================================================
    async function loadMasterData() {
        try {
            ...
            console.log('   Batches:', MASTER.batches.length);
    ...
    function renderRoutines() {
        ...
        filteredRoutines.forEach(r => {
            ...
            const imageUrl = r.image_url || 'data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22100%22 height=%22100%22%3E%3Crect fill=%22%23f0f4ff%22 width=%22100%22 height=%22100%22/%3E%3Ctext x=%2250%25%22 y=%2250%25%22 fill=%22%230a1655%22 font-size=%2235%22 text-anchor=%22middle%22 dy=%22.3em%22%3E📋%3C/text%3E%3C/svg%3E';
    ...
    // =========================================================
    // DYNAMIC FORM FIELDS BASED ON BRANCH (DB-driven)
    // =========================================================
    function updateDynamicFields(branch) {
        ...
        // ---------------------------------------------------
        // Honours: Department (DB) + Batch (DB)
        // ---------------------------------------------------
    ...
    function autoSuggestTitle() {
        ...
        if (branch === 'HSC') {
            ...
            title = `Honours ${field1 || ''} ${field2 ? 'Batch ' + field2 : ''} Class Routine`.trim();
        } else if (branch === 'Degree') {
            title = `Degree ${field1 || ''} ${field2 ? 'Batch ' + field2 : ''} Class Routine`.trim();
        }
        ...
        try {
            ...
            if (selectedImageFile) {
                if (typeof window.FDCUploadImage !== 'function') {
                    throw new Error('Upload function not available. Check cloudinary.js');
                }
    ...
    function deleteRoutine(id) {
        ...
        window.fdcPromptInput({
            ...
            subtitle: r.title,
            message: `
                এই routine <strong>চিরতরে</strong> delete হবে।
    ...
    async function togglePublish(id) {
        ...
        try {
            ...
            if (error) throw error;
            window.fdcSuccess(`Routine সফলভাবে ${action} হয়েছে!`);
            await loadAllRoutines();
        } catch (e) {
    ...
    // =========================================================
    async function init() {
        console.log('🚀 Admin Class Routine v2 initializing...');
        ...
        waitForSupabase(async function () {
            ...
            console.log('✅ Admin Class Routine v2 ready');
        });
    }

 ...
 *    - Sub tabs: Dynamic group-wise (Science/Business/Humanities/CAS/DTB/HRD)
 *    - Status chips filter
 *    - Search (name/phone/appid)
 *    - Stats cards
...
(function () {
    ...
    let currentLevel = 'all';       // all | HSC-General | HSC-BM
    let currentGroup = 'all';       // all | Science | Business | ...
    let currentStatus = 'all';      // all | pending | verified | admitted | cancelled
    let currentSearch = '';

    let actionApplicationId = null; // For verify/admit/cancel modals
    ...
    // =========================================================
    // UPDATE SUB TABS (Group - dynamic based on level)
    // =========================================================
    function updateSubTabs() {
        ...
        if (currentLevel === 'all') {
            // All levels — show all groups combined
            groups = [
    ...
    function updateStatusChips() {
        // Counts are based on current level + group filter
    ...
    // =========================================================
    function init() {
        console.log('🚀 Admin Admissions v1.0 initializing...');
        ...
        waitForSupabase(async function () {
            ...
            console.log('✅ Admin Admissions v1.0 ready');
        });
    }
